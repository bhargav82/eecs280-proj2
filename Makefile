...
blackjack: blackjackPlayer.cpp card.cpp shoe.cpp blackjack.cpp game.cpp highscore.cpp player.cpp
	g++ -Wall -std=c++17 blackjackPlayer.cpp card.cpp shoe.cpp blackjack.cpp game.cpp highscore.cpp player.cpp -o blackjack
