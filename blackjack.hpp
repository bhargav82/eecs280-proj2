...
public:
	...
	// REQUIRES: nothing
	// MODIFIES: top10list
	// EFFECTS: deletes previous pointer and re-assigns the array element to new Highscore object created by vector
	void updateScoreboard();


	// REQUIRES: nothing
	// MODIFIES: nothing
	// EFFECTS: writes to high score with new scores
	void writeToFile();


	// REQUIRES: nothing
	// MODIFIES: top10list
	// EFFECTS: bubble sort to sort elements from high to low
	void sortScoresHighToLow();


	// REQUIRES: filename to read to
	// MODIFIES: vector holding highscore object info
	// EFFECTS: reads through file and fills vector with high scores from file
